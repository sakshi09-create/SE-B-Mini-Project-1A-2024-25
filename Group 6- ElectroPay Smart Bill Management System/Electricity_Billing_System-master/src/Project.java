...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("images/main_gif.gif"));
        ...
        mb.setBorder(new EmptyBorder(10, 10, 10, 10)); // Increased padding
        mb.setPreferredSize(new Dimension(1500, 40));  // Increased height to 40
        ...
        m1.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        m2.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        m3.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        u1.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        u2.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        u3.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        r1.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        ut1.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        ut2.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        ut3.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
        ...
        ex.setFont(new Font("monospaced",Font.PLAIN,16)); // Further increased font size to 16
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("Customer Details")){
            ...
            new DummyPaymentPortal().setVisible(true);
