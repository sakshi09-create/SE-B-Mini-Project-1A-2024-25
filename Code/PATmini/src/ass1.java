...
public class ass1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 615, 403));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(153, 153, 255));
        jLabel1.setText("ASSIGNMENT SECTION");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(107, 36, -1, -1));
    ...
    // SQL query to fetch names from the 'asseen' table
    String query = "SELECT name FROM asseen";
    ...
    try (Connection conn = DriverManager.getConnection(url, user, password);
        ...
        while (rs.next()) {
            ...
            String seenStatus = "seen";

            // Add a new row to the table
            model.addRow(new Object[]{rowCount, name, seenStatus});
        }

        // If no data found
        if (rowCount == 0) {
            JOptionPane.showMessageDialog(this, "No records found in asseen table.");
        }
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ass1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
